  ...
  theme: {
    extend: {
      colors: {
        ...
        // Tier 2/3 only, Tier 1 apps can ignore this entirely
      ...
      borderRadius: {
        ...
        DEFAULT: "var(--radius)",
        brand: "var(--radius)",
        // slightly larger radius for hero/flagship panels (Tier 2/3)
        xl2: "calc(var(--radius) * 1.5)",
      },
      maxWidth: {
        // matches --max-width / the static template's `.wrap` container
        site: "var(--max-width)",
        // wider container for dashboard/bento layouts that outgrow the
        // single-column static-template width — opt in per page
        "site-wide": "1120px",
      },
      fontFamily: {
        sans: ["var(--font-sans)"],
      ...
      // --- Design-system v2 additions (Tier 1/2/3) ---
      fontSize: {
