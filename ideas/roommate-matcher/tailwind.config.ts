  ...
  theme: {
    extend: {
      colors: {
        ...
        // design-system v2 (Tier 3 flagship treatment on this app)
      ...
      borderRadius: {
        ...
        DEFAULT: "var(--radius)",
        brand: "var(--radius)",
        // slightly larger radius for hero/flagship panels
        xl2: "calc(var(--radius) * 1.5)",
      },
      maxWidth: {
        // matches --max-width / the static template's `.wrap` container
        site: "var(--max-width)",
        // wider container for the swipe-deck flagship layout
        "site-wide": "1120px",
      },
      fontFamily: {
        sans: ["var(--font-sans)"],
